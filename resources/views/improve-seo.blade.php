            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ URL::asset("website-hosting") }}"><i class="bi bi-laptop-fill"></i>Website Hosting</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{URL::asset("undraw_profile.svg") }}"/>
                            </a>
                ...
                <div class="container mb-4">
                    <div class="service-wrapper px-4 py-3">
                        ...
                        <div class="service-content-right pr-5">
                            <img src="{{ URL::asset("image/improve-seo.png")}}" alt="Services Images" />
                        </div>
                    </div>
                </div>
            </div>
