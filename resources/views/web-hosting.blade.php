...
<head>
  ...
  <title>MurphysHost - Website Hosting</title>
  ...
  <link
      ...
      rel="stylesheet"
    />
    @php $users = DB::table('products')->get(); @endphp
  <link rel="stylesheet"
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{URL::asset("website-design") }}"><i class="bi bi-laptop-fill"></i>Website Development</a>
            <a class="collapse-item active" href="{{URL::asset("web-hosting") }}"><i class="bi bi-laptop-fill"></i>Website Hosting</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="container mb-4">
          <div class="service-wrapper px-4 py-3">
            <div class="service-content-left pl-4">
              <h2 class="fw-500">Website Hosting</h2>
              <p>
            ...
            <div class="service-content-right pr-5">
              <img src="{{URL::asset("image/web-hosting.png") }}"alt="Services Images" />
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="card shadow mb-4">
                <div class="card-body px-4 py-7">
                  ...
                  <div class="purchase-features">
                    <ul>
                      <li><i class="bi bi-check2-circle"></i>{{$product->description1}}</li>
                      <li>
                        <i class="bi bi-check2-circle"></i>{{$product->description2}}
                      </li>
                      <li><i class="bi bi-check2-circle"></i>{{$product->description3}}</li>
                      <li>
                        <i class="bi bi-check2-circle"></i>{{$product->description4}}
                      </li>
                      <li>
                        <i class="bi bi-check2-circle"></i>{{$product->description5}}
                      </li>
