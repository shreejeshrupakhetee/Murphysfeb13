                        ...
                        @if(count(array($product)) > 0)
                            <form method="POST" action="{{ route('admin.product.update', $product->id) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone" type="text" value="{{$product->price}}" class="form-control @error('price') is-invalid @enderror" name="price" minlength="1" maxlength="3" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone" type="text" value="{{$product->description1}}" class="form-control @error('duration') is-invalid @enderror" name="duration" minlength="1" maxlength="3" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="description" rows="3" cols="100"  class="form-control @error('description') is-invalid @enderror" name="description" minlength="20" maxlength="200" required>{{$product->description1}}
                                        </textarea>
